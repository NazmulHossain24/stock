    ...
    <section class="invoice">
        ...
        <div class="row">
            <div class="col-xs-12">
                <h2 class="page-header">
                    ...
                    <small class="pull-right">Date: <span>{{pub_date($receipt->checkOutDate)}}</span></small>
                </h2>
            </div><!-- /.col -->
        </div>
        <!-- info row -->
        <div class="row invoice-info">
            <div class="col-sm-5 invoice-col">
                From
                <address>
                    <strong>{{$suppliers->name}}</strong><br>
                    Address: <span>{{$suppliers->address}}</span><br>
                    Phone: <span>{{$suppliers->contact}}</span><br>
                    Email: <span>{{$suppliers->email}}</span>
                </address>
            </div><!-- /.col -->
            <div class="col-sm-5 invoice-col">
                To
            ...
            <div class="col-sm-2 invoice-col">
                <strong>Receipt Number <br> #{{invoice_n($receipt->receiptID)}}</strong>
            </div><!-- /.col -->
        ...
        <div class="row">
            ...
            <div class="col-xs-6">
                <p class="lead">Check out date {{pub_date($receipt->checkOutDate)}}</p>
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            <th>Due Amount:</th>
                            <td>{{money($totalAmount - ($returnTotal + $paidAmount))}}</td>
                        </tr>
