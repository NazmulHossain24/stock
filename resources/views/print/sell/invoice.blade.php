    ...
    <section class="invoice">
        <div class="row hidden-print">
            <div class="col-xs-12">
                ...
                <a href="{{url('sell')}}" class="btn btn-lg btn-danger" style="margin-right: 10px;"><i class="fa  fa-chevron-left"></i> Back to Selling</a>
            </div>
        </div>
        <div class="row hidden-print">
        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-2 invoice-col">
                <strong>Invoice Number <br> #{{invoice_n($invoiceID)}}</strong>
            </div><!-- /.col -->
        </div><!-- /.row -->
