...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{Request::url()}}" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b><i class="fa fa-user-secret"></i> </b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><i class="fa fa-user-secret"></i> Admin</span>
    </a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                <li><a href="{{url('/')}}" ><i class="fa fa-user"></i> {{ isset(Auth::user()->name) ? Auth::user()->name : Auth::user()->email }}</a></li>
