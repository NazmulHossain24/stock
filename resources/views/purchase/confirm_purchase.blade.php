...
<div class="wrapper">
    ...
    <section class="invoice">
        ...
        <form action="{{action('purchase\PurchaseController@new_purchase')}}" method="post" enctype="multipart/form-data" autocomplete="off">
            {!! csrf_field() !!}
            <input name="supplierID" type="hidden" value="{{$supplier['supplierID']}}">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <a href="{{url('purchase')}}" class="btn btn-danger" style="margin-right: 10px;"><i class="fa  fa-chevron-left"></i> Back to Purchase</a>
                </div>
            </div>
        </form>
    </section><!-- /.content -->
